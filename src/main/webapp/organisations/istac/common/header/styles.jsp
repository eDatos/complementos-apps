 ...
 * -------------------------- */
        ...
        @font-face {
            ...
            src: url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.eot?v=4.7.0");
            src: url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.eot?#iefix&v=4.7.0") format("embedded-opentype"), url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.woff2?v=4.7.0") format("woff2"), url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.woff?v=4.7.0") format("woff"), url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.ttf?v=4.7.0") format("truetype"), url("<fmt:message key="complementos_apps.url"/>/assets/fonts/font-awesome/fontawesome-webfont.svg?v=4.7.0#fontawesomeregular") format("svg");
            font-weight: normal;
            font-style: normal;
        }
