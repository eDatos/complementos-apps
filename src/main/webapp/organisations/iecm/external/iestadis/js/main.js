$( window ).load(function() {
    ...
    // Inicializamos funcionalidad de pestañas
    $("#tabs").tabs();

    // Inicializamos menú principal
    ...
    /**
     * Mostrar / Ocultar gráficos en home
     **/
    (function(){

        // Ocultamos todos los gráficos inactivos, al inicio
        ...
        // Si se hace click en un +, se muestra su gráfico
        $('.masinfo').on("click", "a", function(ev){
            ...
            if( 
                ...
                // Ocultamos el gráfico activo anterior
                $graficos.hide().removeClass('activo');

                // Mostramos el nuevo gráfico que pasa a ser el activo
    ...
    /**
     * Carrusel pequeño en columna lateral derecha
     **/
    (function(){
    ...
    /**
     * Tarjetas de páginas interiores
     **/
    (function(){
        $(".card")
