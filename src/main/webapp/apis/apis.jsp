...
<% 
  ...
  pageContext.setAttribute("indicatorsRestExternal", resource.getString("indicators.rest.external"));
  pageContext.setAttribute("statisticalResourcesRestExternal", resource.getString("metamac.statistical_resources.rest.external"));
  pageContext.setAttribute("srmRestExternal", resource.getString("metamac.srm.rest.external"));
  pageContext.setAttribute("statisticalOperationsRestExternal", resource.getString("metamac.statistical_operations.rest.external"));
  pageContext.setAttribute("sdmxRegistryRestExternal", resource.getString("metamac.sdmx.registry.rest.external"));
  pageContext.setAttribute("commonMetadataRestExternal", resource.getString("metamac.common_metadata.rest.external"));
  pageContext.setAttribute("portalRestExternalExport", resource.getString("metamac.portal.rest.external.export"));
  pageContext.setAttribute("callejeroRestExternal", resource.getString("callejero.rest.external"));
  pageContext.setAttribute("portalRestExternalPermalinks", resource.getString("metamac.portal.rest.external.permalinks"));
%>
...
<body>		
	...
	<div class="apis">
		<ul class="apis-list">
			<c:if test="${not empty indicatorsRestExternal}">
                <li class="apis-item">
                    <h2><a href="${indicatorsRestExternal}" alt="API de indicadores">API de indicadores</a></h2>
            ...
            <c:if test="${not empty srmRestExternal}">
                <li class="apis-item">
                    <h2><a href="${srmRestExternal}" alt="API de recursos estructurales (activos semánticos)">API de recursos estructurales (activos semánticos)</a></h2>
            ...
            <c:if test="${not empty statisticalOperationsRestExternal}">
                <li class="apis-item">
                    <h2><a href="${statisticalOperationsRestExternal}" alt="API de operaciones estadísticas">API de operaciones estadísticas</a></h2>
            ...
            <c:if test="${not empty sdmxRegistryRestExternal}">
                <li class="apis-item">
                    <h2><a href="${sdmxRegistryRestExternal}" alt="API de Registro SDMX">API de Registro SDMX</a></h2>
            ...
            <c:if test="${not empty commonMetadataRestExternal}">
                <li class="apis-item">
                    <h2><a href="${commonMetadataRestExternal}" alt="API de metadatos comunes">API de metadatos comunes</a></h2>
            ...
            <c:if test="${not empty portalRestExternalExport}">
                <li class="apis-item">
                    <h2><a href="${portalRestExternalExport}" alt="API de exportaciones">API de exportaciones</a></h2>
            ...
            <c:if test="${not empty callejeroRestExternal}">
                <li class="apis-item">
                    <h2><a href="${callejeroRestExternal}" alt="API de callejero (Gazetteer)">API de callejero (Gazetteer)</a></h2>
            ...
            <c:if test="${not empty portalRestExternalPermalinks}">
                <li class="apis-item">
                    <h2><a href="${portalRestExternalPermalinks}" alt="API de enlaces permanentes (permalinks)">API de enlaces permanentes (permalinks)</a></h2>
